...
BEGIN {
  $Dist::Zilla::Tester::VERSION = '4.101800';
}
use Moose;
...
BEGIN {
  $Dist::Zilla::Tester::_Role::VERSION = '4.101800';
}
  use Moose::Role;
...
BEGIN {
  $Dist::Zilla::Tester::_Builder::VERSION = '4.101800';
}
  use Moose;
  extends 'Dist::Zilla::Dist::Builder';
...
BEGIN {
  $Dist::Zilla::Tester::_Minter::VERSION = '4.101800';
}
  use Moose;
