...
{
  $Dist::Zilla::Tester::VERSION = '5.001'; # TRIAL
}
use Moose;
...
{
  $Dist::Zilla::Tester::_Role::VERSION = '5.001'; # TRIAL
}
  use Moose::Role;
...
{
  $Dist::Zilla::Tester::_Builder::VERSION = '5.001'; # TRIAL
}
  use Moose;
  extends 'Dist::Zilla::Dist::Builder';
...
{
  $Dist::Zilla::Tester::_Minter::VERSION = '5.001'; # TRIAL
}
  use Moose;
